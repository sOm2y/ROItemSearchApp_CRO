...
all_skill_entries = {#範例[    "": {"buff":"","type": "技能/料理","code":["",""]},
    ...
    "智慧料理": {"buff":"275","type": "料理","code":["AddExtParam(0,106,10)"],"exclusive": "food_int"},
    "靈巧料理": {"buff":"274","type": "料理","code":["AddExtParam(0,107,10)"],"exclusive": "food_dex"},
    ...
    "體力棒棒條": {"buff":"243","type": "料理","code":["AddExtParam(0,105,15)"],"exclusive": "food_vit"},
    "智慧棒棒條": {"buff":"244","type": "料理","code":["AddExtParam(0,106,15)"],"exclusive": "food_int"}, 
    "靈巧棒棒條": {"buff":"245","type": "料理","code":["AddExtParam(0,107,15)"],"exclusive": "food_dex"},
    "幸運棒棒條": {"buff":"246","type": "料理","code":["AddExtParam(0,108,15)"],"exclusive": "food_luk"},
